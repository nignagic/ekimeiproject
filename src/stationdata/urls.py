...
urlpatterns = [
	...
	path('register/station/edit/<int:station>', views.StationEditView, name='stationedit'),
	path('register/stationservice/edit/<int:stationservice>', views.StationServiceEditView, name='stationserviceedit'),
